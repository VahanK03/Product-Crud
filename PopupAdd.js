        ...
        <div>
            <Popup trigger={<button> Add </button>} position="right top">
                <div>
                    ...
                    <textarea placeholder='Description...' type='text' id='description'></textarea>
                    </div>
                    <div>
                    <span>Content:</span>
                    <textarea placeholder='Content...' type='textarea' id='content'></textarea>
                    </div>
                    <div>
                    <span>Price:</span>
                    ...
                    <span>Brand:</span>
                    <select onChange={(e) => {newProd.Manufacturer = e.target.value}}> 
